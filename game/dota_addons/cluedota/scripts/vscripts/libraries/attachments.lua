...
--[[
  ...
  -Additionally, ensure that you have the cluedota_attachments.xml, cluedota_attachments.js, and cluedota_attachments.css files in your panorama content folder to use the GUI.
...
function Attachments:start()
  Convars:RegisterCommand( "attachment_configure", Dynamic_Wrap(Attachments, 'ActivateAttachmentSetup'), "Attachment Setup: attachment_configure <ADDON_NAME>  (e.g. attachment_configure cluedota)", FCVAR_CHEAT )
