...
HERO_SELECTION_TIME = 3              -- How long should we let people select their hero?
PRE_GAME_TIME = 3                    -- How long after people select their heroes should the horn blow and the game start?
...
MAX_NUMBER_OF_TEAMS = 7                -- How many potential teams can be in this game mode? -1 for "-1"?
...
TEAM_COLORS[DOTA_TEAM_CUSTOM_3] = { 241, 239, 60 }    -- Yellow Yak
TEAM_COLORS[DOTA_TEAM_CUSTOM_4] = { 227, 228, 217 }   -- White Wolf



USE_AUTOMATIC_PLAYERS_PER_TEAM = false   -- Should we set the number of players to 10 / MAX_NUMBER_OF_TEAMS?

CUSTOM_TEAM_PLAYER_COUNT = {7}           -- If we're not automatically setting the number of players per team, use this table
